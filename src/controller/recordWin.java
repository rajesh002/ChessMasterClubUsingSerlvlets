...
/**
 * Servlet implementation class recordWin
 */
@WebServlet("/recordWin")
public class recordWin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int noOfWins= Integer. parseInt(request.getParameter("numberOFWins"));
		try {
